...
import { IForm, SupportedChains } from 'utils/types';
...
const AdvancedForm = ({ isVisible }: AdvancedFormProps) => {
  ...
  const [showMultichainOptions, setShowMultichainOptions] = useState(false);
  ...
  return (
    ...
    >
      ...
      <FormTitle
        ...
        extend={showMultichainOptions}
        setExtend={setShowMultichainOptions}
      />
      <Box width='full' backgroundColor={'separator'} height={1} />
      <FormTitle
        title='VERIFICATION'
